    ...
    const settingSections = [
        ...
        },
        {
            ...
            items: [
                ...
                { icon: 'information-circle', title: 'About', type: 'navigation', onPress: () => navigation.navigate('About') }, // Navigate to About screen
            ],
        },
    ];
...
const styles = StyleSheet.create({
    ...
    profileNameInput: { fontSize: theme.fontSize.xl, fontWeight: 'bold', color: theme.colors.text_primary, padding: theme.spacing.xs, textAlign: 'center' },
    ...
    closeButton: { position: 'absolute', top: 60, right: 20, backgroundColor: 'rgba(0,0,0,0.5)', padding: 8, borderRadius: 20 },
     // ✅ NEW: Modal styles for Change PIN
    modalOverlay: {
        flex: 1,
